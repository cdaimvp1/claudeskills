...
var THEO_DISPO = {
  'Advance':                {c:'#1F7A5A', bg:'#DCEBE9'},
  'Advance with conditions':{c:'#2E5E8C', bg:'var(--ti-blue,#E4EBF1)'},
...
var THEO_CONCERN = {
  'Low':                    {c:'#0F3A85', bg:'var(--ti-blue,#E4EBF1)', fav:0.90},
  'Strong':                 {c:'#1F7A5A', bg:'#DCEBE9',                fav:0.92},
  'Moderate':               {c:'#8A5A00', bg:'var(--ti-amber,#FBF1DA)',fav:0.58},
  'High':                   {c:'#A23A30', bg:'var(--ti-red,#FBE7E3)',  fav:0.32},
  'Critical':               {c:'#7A1F1A', bg:'#F3DEDE',               fav:0.15},
  'Insufficient evidence':  {c:'var(--mut2,#6a655f)', bg:'var(--nested,#f1efec)', fav:0}
};
var THEO_RISKBAND = {
  'Low':     {c:'#0F3A85', bg:'var(--ti-blue,#E4EBF1)'},
  'Moderate':{c:'#8A5A00', bg:'var(--ti-amber,#FBF1DA)'},
  'High':    {c:'#A23A30', bg:'var(--ti-red,#FBE7E3)'},
  'Critical':{c:'#7A1F1A', bg:'#F3DEDE'},
  'Unknown': {c:'var(--mut2,#6a655f)', bg:'var(--nested,#f1efec)'}
};
var THEO_EVID = {
  'Verified':         {c:'#0F3A85', fill:'solid',  key:'verified'},
  'Partial':          {c:'#8A5A00', fill:'hatch',  key:'partial'},
  'Supplier asserted':{c:'#2E5E8C', fill:'outline',key:'supplier'},
...
function pvEvidCoverageBar(cov) {
  cov = cov || {};
  var segs = [
    ['Verified', cov.verified || 0, '#0F3A85'],
    ['Partial', cov.partial || 0, '#8A5A00'],
    ['Supplier input', cov.supplier || 0, '#8FA3BE'],
