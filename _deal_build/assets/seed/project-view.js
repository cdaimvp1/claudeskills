...
(function () {
      ...
      rfx: {
        ...
        suppliers: [
          { n: 'Nimbus Data', contact: 'Sam Rivera', email: 'sam.rivera@nimbusdata.io', landscapeScore: 4.5, mustFail: ['SOC 2 Type II certification'],
            ...
            report: {
              pill: 'Conditional · advisory', stage: 'Evaluation · panel scoring in progress',
              lede: '<b>The strongest functional and commercial submission in the field on Theo’s first-pass read.</b> Full marks (<span class="pos">5 of 5</span>) across data modeling, ETL and self-service analytics, and the most aggressive price on the table at <span class="pos">$980,000/yr</span>, 31% below list and held firm for 90 days. It is blocked by exactly one thing, the <span class="em">SOC 2 Type II gate</span> below, with three material but non-fatal risks behind it.',
              gate: '<b>SOC 2 Type II gate.</b> Nimbus submitted a Type I report; the RFP requires a current Type II at award. The award is barred until the Type II is in hand, regardless of how the rest grades.',
              sections: [
                { title: 'Response assessment', rn: 'How they answered', sub: 'requirements matrix', hint: 'Open submission →', score: 9,
              ...
              overall: {
                take: '<b>Nimbus outscores the field on capability and price, but Theo recommends Lakehouse.</b> Nimbus has the top panel score and the lowest price, and on the merits it would be the pick. It sits at #2 for one reason only: it fails the SOC 2 Type II Must-Have, a hard gate. This is the panel&rsquo;s call, not an automatic loss: accept the risk of proceeding, or secure a dated SOC 2 Type II commitment from Nimbus, and Nimbus becomes the recommendation over <b>Lakehouse Co</b>. Absent that, Lakehouse is the pick.',
                ...
                close: 'Until the gate clears, Theo recommends <b>Lakehouse Co</b>, the gate-pass leader and clean on every Must-Have, with Nimbus as the higher-scored conditional alternative the panel can accept. If Nimbus produces the SOC 2 Type II, it overtakes Lakehouse as the recommendation at a should-cost-adjusted price.' },
          ...
          { n: 'Lakehouse Co', contact: 'Dana Brooks', email: 'dana.brooks@lakehouse.co', landscapeScore: 4.4, mustFail: [],
            ...
            report: {
              pill: 'Conforming · gate-pass leader', stage: 'Evaluation · panel scoring in progress',
              lede: '<b>The conforming benchmark of the field.</b> Lakehouse clears <span class="pos">every Must-Have</span>, holds full SOC 2 Type II and FedRAMP Moderate, and brings the strongest regulated-industry reference base on the table. It trails Nimbus on the panel’s weighted score and on price, at <span class="em">$1.06M/yr</span> against a 10% discount, but it carries no gate and no material risk. Because Nimbus fails the SOC 2 Type II gate, Theo recommends Lakehouse; the panel can overrule to Nimbus by accepting that gate risk or securing a dated remediation.',
              gate: null,
              sections: [
                { title: 'Response assessment', rn: 'How they answered', sub: 'requirements matrix', hint: 'Open submission →', score: 8,
              ...
              overall: {
                take: '<b>Theo&rsquo;s recommendation: the top bidder that clears every Must-Have.</b> Lakehouse holds the field&rsquo;s strongest security and reference posture and is closest to signature. Nimbus outscores it on capability and price, but Nimbus fails the SOC 2 Type II gate, so Theo places Lakehouse first. The panel can overrule: accept Nimbus&rsquo;s gate risk or secure a dated remediation and Nimbus can be chosen instead. Absent that, <b>Lakehouse is the recommendation</b>.',
                ...
                close: 'Lakehouse needs no gate cleared, which is why Theo recommends it today. It is displaced only if the panel accepts the risk of Nimbus&rsquo;s open SOC 2 gate, or Nimbus closes it; short of that, Lakehouse is the pick.' },
          ...
          { n: 'Helio Warehouse', contact: 'Theo Vance', email: 'theo.vance@heliowh.com', landscapeScore: 3.8, mustFail: [],
            ...
            report: {
              ...
              sections: [
                { title: 'Response assessment', rn: 'How they answered', sub: 'requirements matrix', hint: 'Open submission →', score: 5,
 ...
 bidders:[
  {id:'nimbus',name:'Nimbus Data',finalist:true,col:'#0F3A85',basis:'Consumption + committed-use (per credit)',rawAnnual:'~$3.10M / yr',seat:7750,norm:{clean:false,method:'Committed-use annual divided by 400 seats over the 3-yr term.',assumption:'Consumption credits vary by workload, so overage is priced at the committed tier and a peak-concurrency assumption is applied, the per-seat figure moves up if actual usage runs hot.'}},
  {id:'lakehouse',name:'Lakehouse Co',finalist:true,col:'#6A4C93',basis:'Flat committed-use (per cluster)',rawAnnual:'~$2.95M / yr',seat:7375,norm:{clean:true,method:'Flat committed annual divided by 400 seats.',assumption:'Cleanest of the field to normalize, a fixed annual with no consumption variability or bundling to unpick.'}},
  {id:'helio',name:'Helio Warehouse',finalist:false,col:'#A6541C',basis:'Bundled (platform + support)',rawAnnual:'~$2.55M / yr',seat:6375,norm:{clean:false,method:'Bundle split into platform + support at the ratio the vendor stated, then divided by 400 seats.',assumption:'The support component is an estimate pending line-item itemization; if support is later carved out or repriced, the per-seat figure shifts.'}}
 ],
 lines:[
  {item:'Platform fee',unit:'$/seat/yr',lo:6000,hi:8500,target:7000,walk:8000,asks:{nimbus:7750,lakehouse:7375,helio:6375},$src:{target:[stub('Platform-fee negotiation target, normalized $/seat/yr (reflect-only)',1)]}},
  {item:'Implementation',unit:'$K one-time',lo:70,hi:150,target:90,walk:130,asks:{nimbus:140,lakehouse:120,helio:85}},
  {item:'Support',unit:'$/seat/yr',lo:900,hi:1700,target:1200,walk:1500,asks:{nimbus:1500,lakehouse:1350,helio:1100}}
 ]
  };
