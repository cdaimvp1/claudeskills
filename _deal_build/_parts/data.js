...
const dashboardData = {
  ...
  scope: {
    ...
    intendedScope: [
      { id: 'IS-1', text: 'Onboard 4 core HR data sources (HRIS, payroll, recruiting, learning).', origin: 'requested', source: 'RFP §3.1', status: 'in-contract', contractRef: 'SOW-01 D1', confidence: 'High', intended: '4 sources: HRIS, payroll, recruiting, learning', contract: 'D1 delivers all 4 sources', delta: 'None', rec: 'Confirm at kickoff', evidenceType: 'contract' },
      { id: 'IS-2', text: 'Executive + manager dashboard set.', origin: 'requested', source: 'Proposal §2', status: 'in-contract', contractRef: 'SOW-01 D3', confidence: 'High', intended: 'Exec + manager dashboards', contract: 'D3, capped at 12 dashboards', delta: 'Cap at 12', rec: 'Confirm 12 is enough', evidenceType: 'contract' },
      { id: 'IS-3', text: 'SSO / role-based access integration.', origin: 'requested', source: 'RFP §5', status: 'in-contract', contractRef: 'SOW-01 D4', confidence: 'High', intended: 'SSO + RBAC configured', contract: 'D4, owner marked Joint', delta: 'Joint owner, no task split', rec: 'Pin down the Lilly-side tasks (see SH-5)', evidenceType: 'contract' },
      { id: 'IS-4', text: 'Historical data migration, 5 years.', origin: 'requested', source: 'RFP §3.4', status: 'contradicted', contractRef: 'SOW-01 out-of-scope', confidence: 'High', intended: '5 years of history', contract: 'SOW excludes history older than 3 years', delta: '2 years dropped', rec: 'Restore to 5yr, or accept 3yr with a documented waiver', evidenceType: 'contract' },
      { id: 'IS-5', text: 'Exit / transition assistance at end of term.', origin: 'requested', source: 'Proposal §8 · RFP §9', status: 'missing', contractRef: null, confidence: 'High', intended: 'Exit assistance at end of term', contract: 'No exit-assistance clause in SOW or MSA', delta: 'Entirely absent', rec: 'Add an exit-assistance clause before signature', evidenceType: 'inference' },
      { id: 'IS-6', text: 'Predictive attrition / flight-risk modeling.', origin: 'requested', source: 'Proposal §4', status: 'ambiguous', contractRef: 'standard content pack (?)', confidence: 'Moderate', intended: 'Attrition / flight-risk modeling', contract: 'SOW excludes bespoke predictive models', delta: 'Unclear if the standard pack covers it', rec: 'Confirm the standard content pack scope', evidenceType: 'inference' },
      { id: 'IS-7', text: 'Supplier-assisted data-quality remediation during onboarding.', origin: 'requested', source: 'Email 2026-07-08', status: 'missing', contractRef: null, confidence: 'Moderate', intended: 'Supplier-assisted data cleansing', contract: 'SOW assumes Lilly provides clean data', delta: 'Remediation burden lands on Lilly', rec: 'Negotiate supplier remediation, or accept the effort (see SH-2)', evidenceType: 'internal' },
      { id: 'IS-8', text: 'Admin + analyst training.', origin: 'requested', source: 'RFP §6', status: 'partial', contractRef: 'SOW-01 D5', confidence: 'High', intended: 'Admin + analyst training', contract: 'D5, no competency/attendance threshold', delta: 'No acceptance standard', rec: 'Define completion criteria (ties to AC-4)', evidenceType: 'contract' },
      { id: 'AS-1', text: 'Production support / SLAs during the pre-go-live implementation phase.', origin: 'assumed', source: 'Assumed', status: 'missing', contractRef: null, confidence: 'Inferred', intended: 'Availability during onboarding', contract: 'SLA register covers post-go-live only', delta: 'No pre-go-live coverage', rec: 'Add pre-go-live support terms', evidenceType: 'inference' },
      { id: 'AS-2', text: 'Knowledge transfer beyond the 2 training sessions.', origin: 'assumed', source: 'Assumed', status: 'missing', contractRef: null, confidence: 'Inferred', intended: 'KT to Lilly’s analytics team for self-sufficiency', contract: 'Not a stated deliverable', delta: 'Assumed, unwritten', rec: 'Scope KT explicitly, or accept the self-sufficiency risk', evidenceType: 'inference' },
      { id: 'CN-1', text: 'A signed DPA + EU SCCs for employee personal data.', origin: 'norm', source: 'Category norm', status: 'missing', contractRef: null, confidence: 'Category norm', intended: 'DPA + SCCs (category-standard for workforce data)', contract: 'Referenced but not provided', delta: 'Absent', rec: 'Obtain signed DPA (GAP-1, ISS-03)', evidenceType: 'inference' },
      { id: 'CN-2', text: 'Exit / transition-assistance clause.', origin: 'norm', source: 'Category norm', status: 'missing', contractRef: null, confidence: 'Category norm', intended: 'Standard in comparable SaaS exits', contract: 'Absent', delta: 'Absent (matches IS-5)', rec: 'Add exit-assistance clause', evidenceType: 'inference' },
      { id: 'CN-3', text: 'Defined data return + deletion on termination.', origin: 'norm', source: 'Category norm', status: 'partial', contractRef: null, confidence: 'Category norm', intended: 'Return + deletion window', contract: 'Return implied, deletion window unspecified', delta: 'Deletion window missing', rec: 'Specify the deletion window', evidenceType: 'inference' }
    ],
