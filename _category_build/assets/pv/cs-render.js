...
function csKraljicPlot(d) {
  ...
  var W = 760, H = 360, PADL = 96, PADR = 116, PADT = 30, PADB = 52;
  var pw = W - PADL - PADR, ph = H - PADT - PADB;
...
function csConsolScatter(d) {
  ...
  var W = 760, H = 340, PADL = 74, PADR = 30, PADT = 30, PADB = 54;
  var pw = W - PADL - PADR, ph = H - PADT - PADB;
  ...
  var placed = ops.map(function (o) {
    var cx = PADL + (CS_EFFORT_X[o.effort] != null ? CS_EFFORT_X[o.effort] : 0.5) * pw;
    var cy = PADT + ph - ((o.value || 0) / maxV) * ph;
  ...
  var dots = placed.map(function (p) {
    ...
    return '<g class="cs-kdot">' + leader
      ...
      + '" fill="' + k.tone + '" opacity=".82"><title>' + csEsc(p.o.title + ' · ' + k.label + ' · '
