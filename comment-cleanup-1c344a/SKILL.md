...
- Summary of the guardrails (G1-G12; this skill vendors a decision kernel, so **G11 applies to it**, unlike most of the suite where G11 is inert):
...
- **Changelog:**
  ...
  _Suite-wide guardrails note:_ Execution guardrails G1-G12 are defined once in the shared lilly-brand-assets foundation and apply to every skill in the suite; they are not a per-skill version. See the GLOBAL OPERATING RULES section above for the G1-G12 summary.
