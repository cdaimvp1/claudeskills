...
- **Changelog:** (newest first)
  ...
  - Suite-wide guardrails note: this skill inherits the shared G1-G12 execution guardrails defined in the lilly-brand-assets foundation (summarized under GLOBAL OPERATING RULES, Rule 9). That foundation-level guardrail note is not a per-skill version of this skill.
