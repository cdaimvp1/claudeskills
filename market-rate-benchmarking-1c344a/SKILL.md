...
**Search principles:**
- Run a minimum of 3 independent searches per rate line. Aim for 5+ usable data points, which is the threshold to report a percentile band (see Rule 2). With 2 to 4 usable points, report range + median; with 1, report a single reference at LOW confidence.
