...
- **Suite-wide guardrails note:** This skill follows the suite-wide execution guardrails G1-G12 and the suite-wide HARD RULES (no em dashes; deterministic deliverable skeleton; no-fabrication). These are shared standards, not a per-skill version.
