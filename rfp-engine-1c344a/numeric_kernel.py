...
# rfp-engine-1c344a calls: assert_weight_sum() (the Evaluation-weight sanity check, on the 100-percent convention, per category and across the category structure). The remaining functions are vendored for completeness (this is a verbatim copy of the shared kernel) but not called by this skill's own workflow.
"""
numeric_kernel.py
