...
const dashboardData = {
  ...
  scope: {
    ...
    intendedScope: [
      { id: 'IS-1', text: 'Onboard 4 core HR data sources (HRIS, payroll, recruiting, learning).', origin: 'requested', source: 'RFP §3.1', status: 'in-contract', contractRef: 'SOW-01 D1', confidence: 'High', intended: '4 sources: HRIS, payroll, recruiting, learning', iq: '“The solution shall onboard the following four HR data sources: HRIS, payroll, recruiting, and learning.” — RFP §3.1', contract: 'D1 delivers all 4 sources', cq: '“Deliverable D1 — Data-source integration (4 sources).” — SOW-01 §2', delta: 'None — fully covered', impact: 'None (aligned).', rec: 'Confirm the 4 sources at kickoff.', owner: 'Buyer PMO', raiseWith: 'Supplier PM', linked: [], evidenceType: 'contract' },
      { id: 'IS-2', text: 'Executive + manager dashboard set.', origin: 'requested', source: 'Proposal §2', status: 'in-contract', contractRef: 'SOW-01 D3', confidence: 'High', intended: 'Exec + manager dashboards', iq: '“...an executive and manager dashboard set.” — Proposal §2', contract: 'D3, capped at 12 dashboards', cq: '“Deliverable D3 — Dashboard set (up to 12).” — SOW-01 §2', delta: 'Cap at 12 dashboards', impact: 'If Lilly needs more than 12, additional dashboards are a change order.', rec: 'Confirm 12 is enough for the initial rollout.', owner: 'Buyer analytics lead', raiseWith: 'Supplier PM', linked: [], evidenceType: 'contract' },
      { id: 'IS-3', text: 'SSO / role-based access integration.', origin: 'requested', source: 'RFP §5', status: 'in-contract', contractRef: 'SOW-01 D4', confidence: 'High', intended: 'SSO + RBAC configured', iq: '“Single sign-on and role-based access control.” — RFP §5', contract: 'D4, owner marked Joint', cq: '“Deliverable D4 — SSO / RBAC configuration (owner: Joint).” — SOW-01 §2', delta: 'Joint owner, no task split', impact: '“Joint” with no RACI split leaves the Lilly-side config effort unscoped (see SH-5).', rec: 'Pin down which SSO/RBAC tasks are Lilly-owned before M4.', owner: 'Buyer IT', raiseWith: 'Supplier PM', linked: ['SH-5'], evidenceType: 'contract' },
      { id: 'IS-4', text: 'Historical data migration, 5 years.', origin: 'requested', source: 'RFP §3.4', status: 'contradicted', contractRef: 'SOW-01 out-of-scope', confidence: 'High', intended: '5 years of historical data', iq: '“Migrate five (5) years of historical workforce data.” — RFP §3.4', contract: 'SOW excludes history older than 3 years', cq: '“Historical data older than three (3) years is out of scope.” — SOW-01 §4 (Out of scope)', delta: '2 years dropped — direct conflict', impact: '2 yrs of trend / attrition history unavailable at go-live; adding it post-signature is a change order at the uncapped day-rate (ISS-11).', rec: 'Restore to 5yr, or accept 3yr with a documented waiver plus a fixed-price option to add the 2 years later.', owner: 'Category lead', raiseWith: 'Supplier PM + Legal', linked: ['ISS-11'], evidenceType: 'contract' },
      { id: 'IS-5', text: 'Exit / transition assistance at end of term.', origin: 'requested', source: 'Proposal §8 · RFP §9', status: 'missing', contractRef: null, confidence: 'High', intended: 'Exit assistance at end of term', iq: '“Supplier shall provide reasonable transition assistance on exit.” — RFP §9; acknowledged in Proposal §8', contract: 'No exit-assistance clause in the SOW or MSA', cq: 'No corresponding clause found in the reviewed documents.', cqNone: true, delta: 'Entirely absent', impact: 'At term end Lilly has no contractual right to data return, config export or transition support — high switching-cost lock-in.', rec: 'Add an exit-assistance clause (data return + config export + a reasonable transition-services period) before signature.', owner: 'Legal', raiseWith: 'Supplier legal', linked: ['CN-2'], evidenceType: 'inference' },
      { id: 'IS-6', text: 'Predictive attrition / flight-risk modeling.', origin: 'requested', source: 'Proposal §4', status: 'ambiguous', contractRef: 'standard content pack (?)', confidence: 'Moderate', intended: 'Attrition / flight-risk modeling', iq: '“...including predictive attrition and flight-risk insights.” — Proposal §4', contract: 'SOW excludes bespoke predictive models', cq: '“Bespoke predictive models beyond the standard content pack are out of scope.” — SOW-01 §4', delta: 'Unclear whether the standard pack covers attrition', impact: 'If attrition is not in the standard pack, a headline requested capability is silently out of scope — surfaces only after go-live.', rec: 'Get written confirmation the standard content pack includes attrition, or price the model in now.', owner: 'Buyer analytics lead', raiseWith: 'Supplier PM', linked: [], evidenceType: 'inference' },
      { id: 'IS-7', text: 'Supplier-assisted data-quality remediation during onboarding.', origin: 'requested', source: 'Email 2026-07-08', status: 'missing', contractRef: null, confidence: 'Moderate', intended: 'Supplier-assisted data cleansing', iq: '“Can your team help remediate data-quality issues during onboarding?” — email to Supplier, 2026-07-08', contract: 'SOW assumes Lilly provides clean, conformed data', cq: '“Customer will provide data in a clean, conformed format.” — SOW-01 assumptions', delta: 'Remediation burden lands on Lilly', impact: 'If the extracts are not clean, remediation effort is Lilly’s and can slip M2 (see SH-2).', rec: 'Negotiate a supplier-assisted cleansing allowance, or budget the internal effort explicitly.', owner: 'Buyer PMO', raiseWith: 'Supplier PM', linked: ['SH-2'], evidenceType: 'internal' },
      { id: 'IS-8', text: 'Admin + analyst training.', origin: 'requested', source: 'RFP §6', status: 'partial', contractRef: 'SOW-01 D5', confidence: 'High', intended: 'Admin + analyst training', iq: '“Provide administrator and analyst training.” — RFP §6', contract: 'D5, but no competency / attendance threshold', cq: '“Deliverable D5 — Admin + analyst training (2 sessions).” — SOW-01 §2 (acceptance AC-4 undefined)', delta: 'No acceptance standard', impact: '“Training delivered” is unmeasurable — the supplier can claim completion regardless of outcome (acceptance-by-silence).', rec: 'Add an attendance + competency bar to the D5 acceptance criterion (AC-4).', owner: 'Buyer PMO', raiseWith: 'Supplier PM', linked: ['ISS-10'], evidenceType: 'contract' },
      { id: 'AS-1', text: 'Production support / SLAs during the pre-go-live implementation phase.', origin: 'assumed', source: 'Assumed', status: 'missing', contractRef: null, confidence: 'Inferred', intended: 'Availability + support during onboarding', iq: 'Implicit — assumed by Lilly, not stated in any source.', contract: 'The SLA register applies post-go-live only', cq: '“Service levels apply from the go-live date.” — MSA §7.2', delta: 'No pre-go-live coverage', impact: 'An outage during onboarding has no remedy; the whole implementation window is un-SLA’d.', rec: 'Add an implementation-phase availability / support commitment.', owner: 'Buyer PMO', raiseWith: 'Supplier PM', linked: [], evidenceType: 'inference' },
      { id: 'AS-2', text: 'Knowledge transfer beyond the 2 training sessions.', origin: 'assumed', source: 'Assumed', status: 'missing', contractRef: null, confidence: 'Inferred', intended: 'KT to Lilly’s analytics team for self-sufficiency', iq: 'Implicit — assumed for self-sufficiency at handover; not stated.', contract: 'Not a stated deliverable in the SOW', cq: 'No corresponding deliverable found.', cqNone: true, delta: 'Assumed, unwritten', impact: 'Without KT, Lilly stays dependent on the supplier for changes after go-live.', rec: 'Scope KT explicitly, or accept the self-sufficiency risk.', owner: 'Buyer analytics lead', raiseWith: 'Supplier PM', linked: [], evidenceType: 'inference' },
      { id: 'CN-1', text: 'A signed DPA + EU SCCs for employee personal data.', origin: 'norm', source: 'Category norm', status: 'missing', contractRef: null, confidence: 'Category norm', intended: 'DPA + SCCs (category-standard for workforce data)', iq: 'Category norm — standard for HR-data SaaS; expected even though not requested explicitly.', contract: 'Referenced but not provided', cq: '“Data processing per the Supplier Privacy Standard (DPA).” — MSA §9.4 (document not in session)', delta: 'Absent', impact: 'No enforceable data-protection terms for 18,000 employees’ PII — a compliance + signature gate.', rec: 'Obtain the signed DPA + EU SCCs before signature.', owner: 'Privacy / Legal', raiseWith: 'Supplier legal', linked: ['ISS-03', 'GAP-1'], evidenceType: 'inference' },
      { id: 'CN-2', text: 'Exit / transition-assistance clause.', origin: 'norm', source: 'Category norm', status: 'missing', contractRef: null, confidence: 'Category norm', intended: 'Standard in comparable SaaS exits', iq: 'Category norm — standard in comparable SaaS exits.', contract: 'Absent', cq: 'No exit-assistance clause found (matches IS-5).', cqNone: true, delta: 'Absent (matches IS-5)', impact: 'Same exposure as IS-5: no transition rights at term end.', rec: 'Add an exit-assistance clause.', owner: 'Legal', raiseWith: 'Supplier legal', linked: ['IS-5'], evidenceType: 'inference' },
      { id: 'CN-3', text: 'Defined data return + deletion on termination.', origin: 'norm', source: 'Category norm', status: 'partial', contractRef: null, confidence: 'Category norm', intended: 'Return + deletion window on termination', iq: 'Category norm — a defined data return + deletion window.', contract: 'Return implied, deletion window unspecified', cq: '“Data returned on request.” — MSA §9.6 (no deletion window stated)', delta: 'Deletion window missing', impact: 'The deletion obligation is open-ended; PII could persist with the supplier indefinitely.', rec: 'Specify the deletion window.', owner: 'Privacy / Legal', raiseWith: 'Supplier legal', linked: [], evidenceType: 'inference' }
    ],
    ...
    shifts: [
      { id: 'SH-1', text: 'Lilly provides HRIS/payroll extract access within 5 days of kickoff.', source: 'SOW dependency (DEP-1)', shiftType: 'dependency', trigger: 'Kickoff (M1)', stance: 'push-back', impact: 'A tight 5-day window; late access slips the whole critical chain (M2 onward).', rec: 'Widen the window, or add a supplier-side replan if access is delayed.', owner: 'Buyer HRIS', raiseWith: 'Supplier PM', linked: [], evidenceType: 'contract' },
      { id: 'SH-2', text: 'Supplier assumes Lilly supplies clean, conformed data; remediation is Lilly’s.', source: 'Supplier assumption (proposal)', shiftType: 'effort', trigger: 'Data onboarding (M2)', stance: 'push-back', impact: 'The unwritten cost — if data is not clean the effort lands on Lilly; the proposal implied supplier-assisted cleansing (IS-7).', rec: 'Negotiate a supplier-assisted cleansing allowance.', owner: 'Buyer PMO', raiseWith: 'Supplier PM', linked: ['IS-7'], evidenceType: 'inference' },
      { id: 'SH-3', text: 'Deliverables are deemed accepted after 10 days of silence.', source: 'MSA acceptance clause (ISS-10)', shiftType: 'risk', trigger: 'Each deliverable', stance: 'push-back', impact: 'Silence = acceptance shifts the QA burden onto Lilly against a 10-day clock.', rec: 'Require explicit sign-off, or extend the review window.', owner: 'Buyer PMO', raiseWith: 'Supplier PM', linked: ['ISS-10'], evidenceType: 'contract' },
    ...
    sowAssumptions: [
      { id: 'SA-1', assumption: 'Customer will provide data in a clean, conformed format.', ref: 'SOW-01 assumptions', presumes: 'Lilly’s HR extracts are analysis-ready at handover.', burden: 'Lilly', risk: 'If the extracts need remediation, that effort (and any M2 slip) is Lilly’s; the proposal implied supplier-assisted cleansing.', rec: 'Negotiate a supplier-assisted cleansing allowance, or budget the internal remediation effort explicitly.', raiseWith: 'Supplier PM + Buyer data team', linked: ['SH-2', 'IS-7'], evidenceType: 'contract' },
      { id: 'SA-2', assumption: 'SSO / RBAC configuration is a “Joint” responsibility.', ref: 'SOW-01 D4', presumes: 'Lilly supplies unspecified SSO / RBAC configuration effort.', burden: 'Lilly', risk: 'No task split or Lilly-side estimate; the un-scoped config effort surfaces at M4.', rec: 'Split the SSO / RBAC tasks and estimate the Lilly-side effort before M4.', raiseWith: 'Supplier PM + Buyer IT', linked: ['SH-5', 'IS-3'], evidenceType: 'contract' },
      { id: 'SA-3', assumption: 'Deliverables are deemed accepted after 10 business days of silence.', ref: 'SOW-01 §5', presumes: 'Lilly actively reviews and rejects within 10 days, or accepts by default.', burden: 'Lilly', risk: 'Silence = acceptance shifts the QA burden onto Lilly against a short clock; D3 and D5 carry no objective standard.', rec: 'Require explicit written acceptance (not silence), or extend the review window, and add objective criteria for D3 / D5.', raiseWith: 'Supplier PM + Legal', linked: ['SH-3', 'ISS-10'], evidenceType: 'contract' },
      { id: 'SA-4', assumption: 'Historical data older than three years is out of scope.', ref: 'SOW-01 §4', presumes: 'Three years of history is sufficient for Lilly’s analytics.', burden: 'Lilly', risk: 'Lilly asked for five years (IS-4); the extra two years become a post-signature change order at the uncapped day-rate.', rec: 'Restore the 5-year history, or accept 3 years with a fixed-price option to add the 2 years later.', raiseWith: 'Supplier PM + Category lead', linked: ['IS-4', 'SH-4'], evidenceType: 'contract' },
      { id: 'SA-5', assumption: 'Service levels apply from the go-live date.', ref: 'MSA §7.2', presumes: 'No availability / support commitment is needed during onboarding.', burden: 'Lilly', risk: 'The whole implementation window is un-SLA’d; an outage during onboarding has no remedy.', rec: 'Add an implementation-phase availability / support commitment before go-live.', raiseWith: 'Supplier PM', linked: ['AS-1'], evidenceType: 'contract' }
    ]
  },
