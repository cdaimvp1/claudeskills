...
> **The hand-authored reference dashboard was REMOVED (2026-07-30).** It duplicated
> ground a locked hub now renders, so keeping it invited someone to build a second,
> differently-shaped artifact describing the same thing. The dashboard is produced by
> `dashboard/build_profile_dashboard.py`; author the data object, not markup.
