...
# supplier-landscape-1c344a calls: weighted_score() (the 8-pillar percentage-weighted Weighted Scoring Matrix, Full report mode, and the requirement-count-weighted requirements-fit score). The remaining functions are vendored for completeness (this is a verbatim copy of the shared kernel) but not called by this skill's own workflow.
"""
numeric_kernel.py
