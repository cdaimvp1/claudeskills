...
- **Suite-wide guardrails note:** Execution guardrails G1-G13 apply suite-wide (tool-selection rules, mandatory gate checks, definition tracing, data-model-first for dashboards, research minimums, pass-artifact enforcement, anti-collapse signal, pre-delivery self-tests). See the GLOBAL OPERATING RULES section above for the full G1-G13 summary.
