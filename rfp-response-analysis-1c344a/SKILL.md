...
- **Suite-wide guardrails note:** Execution guardrails G1-G10 apply suite-wide (tool selection, gate checks, definition tracing, data-model-first for dashboards, pass-artifact enforcement, anti-collapse). See the GLOBAL OPERATING RULES block above and `the "## INLINED: references/execution-guardrails.md" section inside /mnt/skills/user/lilly-brand-assets-1c344a/SKILL.md`. This is a suite convention, not a per-skill version.
- **Changelog:**
